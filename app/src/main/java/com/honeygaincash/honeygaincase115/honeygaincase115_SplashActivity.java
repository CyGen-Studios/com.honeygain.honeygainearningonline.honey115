...
public class honeygaincase115_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase115_splash);
    ...
    void datafromlink() {
        new AsyncTask< Void, Void, String >() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/85d3b0893e/ads.txt";
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                honeygaincase115_SplashActivity.this.startActivity(new Intent(honeygaincase115_SplashActivity.this, honeygaincase115_start_page.class));
